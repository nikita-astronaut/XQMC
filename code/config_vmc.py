...
class MC_parameters:
    def __init__(self):
        ...
        self.workdir = '/home/astronaut/Documents/DQMC_TBG/logs/7/'
        ...
        self.pairings_list = pairings.twoorb_hex_A1_N_singlet + pairings.twoorb_hex_A1_N_triplet + pairings.twoorb_hex_A2_N_singlet + pairings.twoorb_hex_A2_N_triplet + pairings.twoorb_hex_E_N_singlet + \
           pairings.twoorb_hex_A1_NN_singlet + pairings.twoorb_hex_A1_NN_triplet + pairings.twoorb_hex_A2_NN_singlet + pairings.twoorb_hex_A2_NN_triplet + \
           pairings.twoorb_hex_E_NN_singlet + pairings.twoorb_hex_E_NN_triplet
    ...
    def select_initial_muBCS(self):
        ...
        lowest_energy_states = np.argsort(E)[:self.Ne]
        return np.max(E[lowest_energy_states])
