...
class MC_parameters:
    def __init__(self):
        ...
        self.observables_log_name = '/home/astronaut/DQMC_TBG/logs/observables'
        pairings.obtain_all_pairings(self)

        self.pairings_list = [pairings.on_site_1orb_hex_real[0], pairings.NN_1orb_hex_real[0], pairings.NN_1orb_hex_real[1], pairings.NN_1orb_hex_imag[1]]
