...
class MC_parameters:
    def __init__(self):
        ...
        self.N_electrons = 64 # only applied if PN_projection = True
        self.correlation = 100
        self.opt_parameters = [1e+2, 10]  # regularizer for the S_stoch matrix, learning rate
        ...
        self.initial_gap_parameters = np.array([0.01, 0.01, 0.01])
        self.initial_jastrow_parameters = np.array([1.4, 1.0, 0.7])
        ...
        self.pairings_list = [pairings.NN_pairings_1orb_hex_real[2], pairings.NN_pairings_1orb_hex_real[3], pairings.NN_pairings_1orb_hex_imag[3]]
        self.pairings_list_names = ['D-wave_re', 'iD-wave_re', 'iD-wave_im']
