...
class MC_parameters:
    def __init__(self):
        ...
        self.U = [2., 6.0, 8.0] # the force of on-site Coulomb repulsion in the units of t1
        ...
        #self.pairings_list = [pairings.on_site_1orb_hex_real[0], pairings.on_site_1orb_hex_real[1], pairings.NN_1orb_hex_real[0], pairings.NN_1orb_hex_real[1], pairings.NN_1orb_hex_imag[1], pairings.NN_1orb_hex_real[2], pairings.NN_1orb_hex_imag[2], pairings.NN_1orb_hex_real[3], pairings.NN_1orb_hex_imag[3]]
