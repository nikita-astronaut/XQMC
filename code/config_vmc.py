...
class MC_parameters:
    def __init__(self):
        ...
        self.U = 10 # the force of on-site Coulomb repulsion in the units of t1
        ...
        self.N_electrons = 200 # only applied if PN_projection = True
        ...
        self.initial_gap_parameters = np.array([0.1, 0.1, 0.1])
