...
config_dqmc_import = config_dqmc_file.simulation_parameters(int(sys.argv[2]), float(sys.argv[3]), rank)

config = cv_module.simulation_parameters(int(sys.argv[2]), float(sys.argv[3]), rank)
