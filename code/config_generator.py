...
class simulation_parameters:
    def __init__(self):
        self.Ls = 4  # spatial size, the lattice will be of size Ls x Ls
        ...
        self.nu_V = nu_V
        self.nu_U = nu_U
        self.mu = -1.1 # (meV), chemical potential of the lattice
        ...
        self.n_print_frequency = 30  # write to log every n_print_frequency spin flips
