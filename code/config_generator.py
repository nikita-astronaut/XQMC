...
class simulation_parameters:
    def __init__(self, Nt, U, rank):
        ...
        self.workdir = '/s/ls4/users/astrakhantsev/DQMC_TBG/logs/2x2_measXZ_{:.3f}/logs_dqmc_real_{:d}_{:d}/'.format(self.U[0], self.Nt[0], rank)
        self.workdir_heavy = '/s/ls4/users/astrakhantsev/DQMC_TBG/logs/2x2_measXZ_{:.3f}/logs_dqmc_real_{:d}_{:d}/'.format(self.U[0], self.Nt[0], rank)
