...
class simulation_parameters:
    def __init__(self):
        ...
        self.Nt = 36  # the number of time slices for the Suzuki-Trotter procedure
        ...
        self.n_sweeps = 20000  # the number of spin flips starting from the initial configuration (can be used both for thermalization and generation)
