...
class simulation_parameters:
    def __init__(self):
        ...
        self.Nt = np.array([60])  # the number of time slices for the Suzuki-Trotter procedure
        ...
        self.n_print_frequency = 50  # write to log every n_print_frequency spin flips
