...
dt_in_inv_t1 = 0.2
U_in_t1 = np.ones(36) * 2
V_in_t1 = np.ones(36) * 2
main_hopping = 1.0

class simulation_parameters:
    def __init__(self):
        self.Ls = 8  # spatial size, the lattice will be of size Ls x Ls
        self.Nt = np.concatenate([np.linspace(20, 52, 9), np.linspace(20, 52, 9), np.linspace(20, 52, 9), np.linspace(20, 52, 9)])  # the number of time slices for the Suzuki-Trotter procedure
